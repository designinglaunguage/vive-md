...
| Phase 0 | 용어정의서 | `TERM-[프로젝트코드]-v[버전].md` | 권장 |
...
| Phase 4 | 코딩 핸드오프 문서 | `CODING_HANDOFF-[프로젝트코드]-v[버전].md` | 필수 |
...
| Phase 6 | 릴리스 체크리스트 | `RELEASE_CHECKLIST-[프로젝트코드]-v[버전].md` | 필수 |
| Phase 7 | 유지보수 계획서 | `MTP-[프로젝트코드]-v[버전].md` | 필수 |
| Phase 7 | 운영 RUNBOOK | `RUNBOOK-[프로젝트코드]-v[버전].md` | 필수 |
...
| 공통 | 리뷰 로그 | `REVIEW_LOG-[프로젝트코드].md` | 권장 |
...
> AI 코딩으로 구현을 넘기기 전에 요구사항 ID, 영향 범위, 금지 변경, 계약, 검증 명령을 확정하는 구현 단계 문서이다.

- 템플릿 파일: `04-구현/CODING_HANDOFF.md`
- 한 문서는 한 구현 사이클과 요구사항 1~3개만 다룬다.
- placeholder가 남아 있으면 AI 코딩을 시작하지 않는다.
...
| "코딩 핸드오프 작성해줘" | 코딩 핸드오프 문서 | `04-구현/CODING_HANDOFF.md` |
| "Git 전략 만들어줘" | 소스 코드 관리 계획 | 5.2 |
